...
import { isPresent, isBlank, BaseException, StringWrapper, RegExpWrapper, NumberWrapper } from 'angular2/src/facade/lang';
...
export class PerflogMetric extends Metric {
     ...
     **/
    constructor(_driverExtension, _setTimeout, _microMetrics, _forceGc, _captureFrames) {
        super();
...
var _BINDINGS = [
    bind(PerflogMetric)
        .toFactory((driverExtension, setTimeout, microMetrics, forceGc, captureFrames) => new PerflogMetric(driverExtension, setTimeout, microMetrics, forceGc, captureFrames), [
        WebDriverExtension,
        _SET_TIMEOUT,
